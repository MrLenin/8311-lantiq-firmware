...
******************************************************************************/
/**
   \file drv_onu_resource_device_psb98010.h
*/
#ifndef _drv_onu_resource_device_psb98010_h
#define _drv_onu_resource_device_psb98010_h
...
#define ONU_GPE_MAX_METER                   64

/** Number of Ethernet UNI ports */
#if !defined(ONU_MAX_ETH_UNI) || (ONU_MAX_ETH_UNI > 2)
#define ONU_GPE_MAX_ETH_UNI                  2
#else
