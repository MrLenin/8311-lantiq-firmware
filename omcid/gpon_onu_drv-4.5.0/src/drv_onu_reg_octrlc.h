...
#ifndef _drv_onu_reg_octrlc_h
#define _drv_onu_reg_octrlc_h

/** \addtogroup OCTRLC_REGISTER
   @{
*/
/* access macros */
#define octrlc_r32(reg) reg_r32(&octrlc->reg)
#define octrlc_w32(val, reg) reg_w32(val, &octrlc->reg)
#define octrlc_w32_mask(clear, set, reg) reg_w32_mask(clear, set, &octrlc->reg)
#define octrlc_r32_table(reg, idx) reg_r32_table(octrlc->reg, idx)
#define octrlc_w32_table(val, reg, idx) reg_w32_table(val, octrlc->reg, idx)
#define octrlc_w32_table_mask(clear, set, reg, idx) reg_w32_table_mask(clear, set, octrlc->reg, idx)
#define octrlc_adr_table(reg, idx) adr_table(octrlc->reg, idx)


/** OCTRLC register structure */
struct onu_reg_octrlc
{
   /** Control Register
...
#define OCTRLC_CTRL_REQ 0x00000020
...
#define OCTRLC_CTRL_BMX 0x00000010
/* Disable
#define OCTRLC_CTRL_BMX_DIS 0x00000000 */
/** Enable */
#define OCTRLC_CTRL_BMX_EN 0x00000010
/** Reset Receiver
    When this bit is set the receiver is reseted */
#define OCTRLC_CTRL_RSR 0x00000008
/** Reset Transmitter
    When this bit is set the transmitter is reseted */
#define OCTRLC_CTRL_RSX 0x00000004
...
#define OCTRLC_CTRL_SOP 0x00000002
...
#define OCTRLC_CTRL_EOP 0x00000001
...
#define OCTRLC_IRNCR_TXE 0x00000010
/* Nothing
#define OCTRLC_IRNCR_TXE_NULL 0x00000000 */
/** Read: Interrupt occurred. */
#define OCTRLC_IRNCR_TXE_INTOCC 0x00000010
/** Transmit FIFO Ready
...
#define OCTRLC_IRNCR_TXR 0x00000008
/* Nothing
#define OCTRLC_IRNCR_TXR_NULL 0x00000000 */
/** Read: Interrupt occurred. */
#define OCTRLC_IRNCR_TXR_INTOCC 0x00000008
/** Receive FIFO Ready
...
#define OCTRLC_IRNCR_RXR 0x00000004
/* Nothing
#define OCTRLC_IRNCR_RXR_NULL 0x00000000 */
/** Read: Interrupt occurred. */
#define OCTRLC_IRNCR_RXR_INTOCC 0x00000004
/** Start-of-Packet
...
#define OCTRLC_IRNCR_SOP 0x00000002
/* Nothing
#define OCTRLC_IRNCR_SOP_NULL 0x00000000 */
/** Read: Interrupt occurred. */
#define OCTRLC_IRNCR_SOP_INTOCC 0x00000002
/** End-of-Packet
...
#define OCTRLC_IRNCR_EOP 0x00000001
/* Nothing
#define OCTRLC_IRNCR_EOP_NULL 0x00000000 */
/** Read: Interrupt occurred. */
#define OCTRLC_IRNCR_EOP_INTOCC 0x00000001

/* Fields of "IRN Interrupt Control Register" */
/** Transmit FIFO Empty
    Interrupt control bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNICR_TXE 0x00000010
/** Transmit FIFO Ready
    Interrupt control bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNICR_TXR 0x00000008
/** Receive FIFO Ready
    Interrupt control bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNICR_RXR 0x00000004
/** Start-of-Packet
    Interrupt control bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNICR_SOP 0x00000002
/** End-of-Packet
    Interrupt control bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNICR_EOP 0x00000001

/* Fields of "IRN Interrupt Enable Register" */
/** Transmit FIFO Empty
    Interrupt enable bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNEN_TXE 0x00000010
/* Disable
#define OCTRLC_IRNEN_TXE_DIS 0x00000000 */
/** Enable */
#define OCTRLC_IRNEN_TXE_EN 0x00000010
/** Transmit FIFO Ready
    Interrupt enable bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNEN_TXR 0x00000008
/* Disable
#define OCTRLC_IRNEN_TXR_DIS 0x00000000 */
/** Enable */
#define OCTRLC_IRNEN_TXR_EN 0x00000008
/** Receive FIFO Ready
    Interrupt enable bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNEN_RXR 0x00000004
/* Disable
#define OCTRLC_IRNEN_RXR_DIS 0x00000000 */
/** Enable */
#define OCTRLC_IRNEN_RXR_EN 0x00000004
/** Start-of-Packet
    Interrupt enable bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNEN_SOP 0x00000002
/* Disable
#define OCTRLC_IRNEN_SOP_DIS 0x00000000 */
/** Enable */
#define OCTRLC_IRNEN_SOP_EN 0x00000002
/** End-of-Packet
    Interrupt enable bit for the corresponding bit in the IRNCR register. */
#define OCTRLC_IRNEN_EOP 0x00000001
/* Disable
#define OCTRLC_IRNEN_EOP_DIS 0x00000000 */
/** Enable */
#define OCTRLC_IRNEN_EOP_EN 0x00000001

/* Fields of "Length Register" */
/** Receiver Packets
    Returns the number of complete packets which are curently stored in the receive FIFO. */
#define OCTRLC_LEN_PACR_MASK 0x07000000
/** field offset */
#define OCTRLC_LEN_PACR_OFFSET 24
/** Receiver Length
...
#define OCTRLC_LEN_LENR_MASK 0x00070000
/** field offset */
#define OCTRLC_LEN_LENR_OFFSET 16
/** Transmitter Packets
    Returns the number of complete packets which are currently stored in the transmit FIFO. */
#define OCTRLC_LEN_PACX_MASK 0x00000300
/** field offset */
#define OCTRLC_LEN_PACX_OFFSET 8
/** Transmitter Length
...
#define OCTRLC_LEN_LENX_MASK 0x00000003
/** field offset */
#define OCTRLC_LEN_LENX_OFFSET 0
...
#define OCTRLC_DATA0_DATA0_MASK 0xFFFFFFFF
/** field offset */
#define OCTRLC_DATA0_DATA0_OFFSET 0
...
#define OCTRLC_DATA1_DATA1_MASK 0xFFFFFFFF
/** field offset */
#define OCTRLC_DATA1_DATA1_OFFSET 0

/*! @} */ /* OCTRLC_REGISTER */

#endif /* _drv_onu_reg_octrlc_h */
