...
/*
 * ============================================================================
 *  New ioctls (not in v4.5.0 SDK, available in shipping kernel)
 * ============================================================================
 *
 * These are defined here for reference. The struct definitions would need to
 * be reverse-engineered from the kernel module to be usable.
 */
...
/* ASC0 serial pin configuration — struct size TBD */
/* #define FIO_ONU_ASC0_PIN_CFG_SET ... */
/* #define FIO_ONU_ASC0_PIN_CFG_GET ... */

/* Port mapping — struct size TBD */
/* #define FIO_ONU_PORTMAP_SET ... */
/* #define FIO_ONU_PORTMAP_GET ... */
